...
class Translator final
{
  ...
  public:
    ...
    auto buildDesignFile(vhdlParser::Design_fileContext* ctx) -> ast::DesignFile;
  ...
  private:
    ...
    [[nodiscard]] auto makeArchitectureDeclarativeItem(vhdlParser::Block_declarative_itemContext& ctx) -> ast::Declaration;
    ...
    [[nodiscard]] auto makeConstrainedArray(vhdlParser::Constrained_array_definitionContext& ctx) -> ast::ArrayTypeDef;
    ...
    [[nodiscard]] auto makeUnconstrainedArray(vhdlParser::Unconstrained_array_definitionContext& ctx) -> ast::ArrayTypeDef;

    // Statements
    [[nodiscard]] auto makeConcurrentStatement(vhdlParser::Architecture_statementContext& ctx) -> ast::ConcurrentStatement;
    ...
    [[nodiscard]] auto makeSequentialStatementKind(vhdlParser::Sequential_statementContext& ctx) -> ast::SequentialStmtKind;
    ...
    [[nodiscard]] auto makeSelectedAssign(vhdlParser::Selected_signal_assignmentContext& ctx) -> ast::SelectedConcurrentAssign;
    ...
    // Expressions
    [[nodiscard]] auto makeAggregate(vhdlParser::AggregateContext& ctx) -> ast::GroupExpr;
    [[nodiscard]] auto makeAllocator(vhdlParser::AllocatorContext& ctx) -> ast::UnaryExpr;
    ...
    [[nodiscard]] auto makeQualifiedExpr(vhdlParser::Qualified_expressionContext& ctx) -> ast::QualifiedExpr;
