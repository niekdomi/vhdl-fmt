...
TEST_CASE("Context Clauses", "[design_units][context]")
{
    ...
    SECTION("Library Clauses")
    {
        SECTION("Single library")
        {
            ...
            CHECK(lib->logical_names.at(0) == "ieee");
        }
        ...
        SECTION("Multiple libraries")
        {
            ...
            CHECK(std::get<ast::LibraryClause>(unit->context.at(0)).logical_names.at(0) == "ieee");
            CHECK(std::get<ast::LibraryClause>(unit->context.at(1)).logical_names.at(0) == "work");
        }
        ...
        SECTION("Multiple names in one clause")
        {
            ...
            CHECK(lib->logical_names.at(0) == "ieee");
            CHECK(lib->logical_names.at(1) == "std");
            CHECK(lib->logical_names.at(2) == "work");
        }
    }
    ...
    SECTION("Use Clauses")
    {
        SECTION("Single use")
        {
            ...
            CHECK(use->selected_names.at(0) == "ieee.std_logic_1164.all");
        }
        ...
        SECTION("Multiple use names")
        {
            ...
            CHECK(use->selected_names.at(0) == "ieee.std_logic_1164.all");
            CHECK(use->selected_names.at(1) == "ieee.numeric_std.all");
        }
    }
    ...
    SECTION("Mixed Context")
    {
        ...
        CHECK(std::holds_alternative<ast::LibraryClause>(unit->context.at(0)));
        CHECK(std::holds_alternative<ast::UseClause>(unit->context.at(1)));
    }
}
