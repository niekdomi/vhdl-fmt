...
TEST_CASE("ForLoop", "[statements][for_loop]")
{
    ...
    {
        const auto *for_loop = parse_loop("for i in 0 to 7 loop\n"
                                          "    temp := data(i);\n"
    ...
    {
        const auto *outer_loop = parse_loop("for i in 0 to 3 loop\n"
    ...
    {
        const auto *for_loop = parse_loop("for idx in 0 to 255 loop\n"
                                          "    memory(idx) := (others => '0');\n"
                                          "end loop;");
        REQUIRE(for_loop != nullptr);
    ...
    {
        const auto *for_loop = parse_loop("for i in 0 to 10 loop\n"
                                          "    if i mod 2 = 0 then\n"
                                          "        even_sum := even_sum + i;\n"
                                          "    else\n"
                                          "        odd_sum := odd_sum + i;\n"
