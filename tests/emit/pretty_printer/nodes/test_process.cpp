...
TEST_CASE("Process Rendering", "[pretty_printer][process]")
{
    ...
    SECTION("Process with Declarations")
    {
        ...
        var.names = { "counter" };
        var.subtype = ast::SubtypeIndication{ .resolution_func = std::nullopt, .type_mark = "integer", .constraint = std::nullopt };
        ...
        constant.names = { "MAX" };
        constant.subtype = ast::SubtypeIndication{ .resolution_func = std::nullopt, .type_mark = "integer", .constraint = std::nullopt };
