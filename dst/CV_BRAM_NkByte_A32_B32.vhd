...
ARCHITECTURE impl OF BRAM_NkByte_A32_B32 IS
	...
	PORT (
		...
		address_a	: IN STD_LOGIC_VECTOR (pkg_log2(256*C_NO_OF_KBYTE)-1 downto 0);
...
BEGIN
	...
	GENERIC MAP (
		...
		widthad_a 					=> pkg_log2(256*C_NO_OF_KBYTE),
