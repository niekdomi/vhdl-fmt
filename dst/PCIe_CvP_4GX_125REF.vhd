-- megafunction wizard: %Cyclone V Hard IP for PCI Express v14.1%
-- GENERATION: XML
-- PCIe_CvP_4GX_125REF.vhd

-- Generated using ACDS version 14.1 190 at 2015.04.30.16:35:49
...
end entity PCIe_CvP_4GX_125REF;

architecture rtl of PCIe_CvP_4GX_125REF is
	component altpcie_cv_hip_ast_hwtcl is
		generic (
			ACDS_VERSION_HWTCL                        : string  := "14.1";
...
begin
	...
	pcie_cvp_4gx_125ref_inst : component altpcie_cv_hip_ast_hwtcl
		generic map (
			ACDS_VERSION_HWTCL                        => "14.1",
			lane_mask_hwtcl                           => "x4",
...
end architecture rtl; -- of PCIe_CvP_4GX_125REF
...
---->
-- Retrieval info: <instance entity-name="altera_pcie_cv_hip_ast" version="14.1" >
-- Retrieval info: 	<generic name="ACDS_VERSION_HWTCL" value="14.1" />
...
-- Retrieval info: 	<generic name="pll_refclk_freq_hwtcl" value="125 MHz" />
...
-- Retrieval info: 	<generic name="bar0_size_mask_0_hwtcl" value="28" />
...
-- Retrieval info: 	<generic name="vendor_id_0_hwtcl" value="0" />
-- Retrieval info: 	<generic name="device_id_0_hwtcl" value="1" />
...
-- Retrieval info: 	<generic name="subsystem_device_id_0_hwtcl" value="0" />
