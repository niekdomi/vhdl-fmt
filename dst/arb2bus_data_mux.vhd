-------------------------------------------------------------------------------
-- $Id: arb2bus_data_mux.vhd,v 1.3 2004/11/23 00:55:26 jcanaris Exp $
-------------------------------------------------------------------------------
...
use opb_arbiter_v1_02_d.mux_onehot;
use opb_arbiter_v1_02_d.or_bits;
...
ARB2BUS_DATAMUX_I: entity opb_arbiter_v1_02_d.mux_onehot
...
-------------------------------------------------------------------------------
ARB2BUS_RDACK_I: entity opb_arbiter_v1_02_d.or_bits
...
-------------------------------------------------------------------------------
ARB2BUS_WRACK_I: entity opb_arbiter_v1_02_d.or_bits
    generic map (   C_NUM_BITS  => C_NUM_MASTERS+1,
                    C_START_BIT => 0,
                    C_BUS_SIZE  => C_NUM_MASTERS+1)
    port map    (
