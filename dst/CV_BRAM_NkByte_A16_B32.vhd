...
--$Rev:: 3706                                                                  $
--$Author:: leuthold                                                           $
--$Date:: 2015-01-08 11:02:40 +0100 (Do, 08 Jan 2015)                          $
--------------------------------------------------------------------------------
...
ARCHITECTURE impl OF BRAM_NkByte_A16_B32 IS
	...
	PORT (
		...
		address_b	: IN STD_LOGIC_VECTOR (pkg_log2(256*C_NO_OF_KBYTE)-1 downto 0);
...
BEGIN
	...
	GENERIC MAP (
		...
		widthad_b 					=> pkg_log2(256*C_NO_OF_KBYTE),
		width_a 					=> 16,
		width_b 					=> 32,
		width_byteena_a 			=> 2,
		width_byteena_b 			=> 4,
