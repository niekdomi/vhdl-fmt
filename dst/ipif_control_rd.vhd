-------------------------------------------------------------------------------
-- $Id: ipif_control_rd.vhd,v 1.6 2006/02/14 19:29:12 dougt Exp $
-------------------------------------------------------------------------------
--ipif_control_rd.vhd   
-------------------------------------------------------------------------------
--
...
begin
   ...
   -- BUS_LEQ_32 : if (REG_DWIDTH <= 32) generate
   -- 
   --      
   -- begin
   --    
   ...
   BUILD_STATUS_NO_FIT : if (REG_DWIDTH < C_DP_ADDRESS_WIDTH+7
      ...
      constant OCC_INDEX_END : Integer := (REG_DWIDTH-7)-1;
      ...
      BUILD_STATUS_BUS : process (reg_deadlock, reg_almostempty, reg_empty,
        ...
        Begin
           ...
           for j in 0 to OCC_INDEX_END loop
              ...
              status_bus((REG_DWIDTH-1)-OCC_INDEX_END+j) 
                     <=  reg_occupancy(j);
    ...
    GEN_WR_ERROR : process (Bus_rst, Bus_clk)
        Begin
          ...
          Elsif (Bus_clk'EVENT and Bus_clk = '1') Then
             ...
             If (Bus2FIFO_WrCE2 = '1'          -- Attempting to write to the status reg 
