...
end entity UFM_Flash;

architecture rtl of UFM_Flash is
...
begin
	...
	onchip_flash_0 : component altera_onchip_flash
		generic map (
			INIT_FILENAME                       => "C:/Projects/Customers/Besi/BSAT/BSAT_Slave_Template_08/BSAT_onchip_flash.mif",
			...
			FLASH_RESET_CYCLE_MAX_INDEX         => 15,
			FLASH_BUSY_TIMEOUT_CYCLE_MAX_INDEX  => 75,
			FLASH_ERASE_TIMEOUT_CYCLE_MAX_INDEX => 21875000,
			FLASH_WRITE_TIMEOUT_CYCLE_MAX_INDEX => 19062,
			PARALLEL_MODE                       => true,
			READ_AND_WRITE_MODE                 => true,
			WRAPPING_BURST_MODE                 => false,
			IS_DUAL_BOOT                        => Dual_Boot,
			IS_ERAM_SKIP                        => Dual_Boot,
...
end architecture rtl; -- of UFM_Flash
