--------------------------------------------------------------------------------
--
--  Virtex-4	BRAM_1kByte_A16_B16.vhd
--
--------------------------------------------------------------------------------
--
--  project     : GS_LINK
...
--$Rev:: 3025                                                                  $
--$Author:: leuthold                                                           $
--$Date:: 2013-10-22 10:44:15 +0200 (Di., 22 Okt 2013)                         $
--------------------------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY BRAM_1kByte_A16_B16 is 
	generic (
   		BRAM_Init		: tSLV_Nx16(0 to 1023) := (others => (others => '0'))      
	);
	port (
...
--------------------------------------------------------------------------------
	...
	ADDR_A <= '0' & '0' &i_BRAM_Addr_A & "0000";		
	ADDR_B <= '0' & '0' &i_BRAM_Addr_B & "0000"; 
	
	ram2x : for i in 0 to 0 generate
	begin
		RAMB16_inst : RAMB16
		generic map (
