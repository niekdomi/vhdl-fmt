...
ENTITY BRAM_2kByte_A32_B32 is 

	generic (
		BRAM_Init		: tSLV_Nx32(0 to 511) := (others => (others => '0'))
	);
	port (
...
-- internal signals
--------------------------------------------------------------------------------
	shared variable RAM : tSLV_Nx32(0 to 511) := BRAM_Init;
	--signal RAM : tMEM := MEM;
