-------------------------------------------------------------------------------
-- $Id: park_lock_logic.vhd,v 1.2 2003/03/31 19:15:36 anitas Exp $
-------------------------------------------------------------------------------
...
-- Xilinx primitives are in UNISIM library.
library unisim;
use unisim.all;
...
PARKLOGIC_GEN: if C_PARK generate
    ...
    begin
      ...
      PENDREQ_I: or_gate generic map (C_NUM_MASTERS-1,1,TRUE)
    ...
    PARK_GEN: for i in 0 to C_NUM_MASTERS-1 generate
        ...
        begin
         ...
         OTHERSPARK_I: or_gate generic map (C_NUM_MASTERS-1,1,TRUE)
