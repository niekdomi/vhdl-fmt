-- MODULE MRAM Control
-- VHDL Architecture Indel_lib.MRAM_Control.Universal
--
...
ENTITY MRAM_Control IS
  PORT (
        MRAM_CLK                  : IN    std_logic; -- 125MHz
        MRAM_CLK_EXT              : IN    std_logic; -- 62.5MHz
        MRAM_CLR_n                : IN    std_logic;
        PPC_Dock                  : INOUT router_dock_t_s_pkg;
        MRAM_nCS                  : OUT   std_logic; -- MRAM chip select
        MRAM_nOE                  : OUT   std_logic; -- MRAM output enable
        MRAM_nWE                  : OUT   std_logic; -- MRAM write enable
        MRAM_nUB                  : OUT   std_logic; -- MRAM upper byte enable
        MRAM_nLB                  : OUT   std_logic; -- MRAM lower byte enable
        MRAM_A                    : OUT   std_logic_vector(Return_Upper_F_I_PKG(MRAM_AD_Width_C_S_PKG) DOWNTO 0); -- MRAM address output
        X_Bus_MRAM_Data           : IN    std_logic_vector(Return_Upper_F_I_PKG(MRAM_D_Width_C_S_PKG) DOWNTO 0); -- MRAM input data signals
        MRAM_X_Bus_Data           : OUT   std_logic_vector(Return_Upper_F_I_PKG(MRAM_D_Width_C_S_PKG) DOWNTO 0) -- MRAM output data signals
        );
END ENTITY MRAM_Control;


ARCHITECTURE Universal OF MRAM_Control IS
