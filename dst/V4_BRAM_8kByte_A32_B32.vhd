--------------------------------------------------------------------------------
--
--  Virtex-4	BRAM_8kByte_A32_B32.vhd
--
--------------------------------------------------------------------------------
--
--  project     : GS_LINK
...
ENTITY BRAM_8kByte_A32_B32 is
	...
	port (
		...
		i_BRAM_WrData_A : IN  std_logic_vector(31 downto 0) := (others => '0');
		o_BRAM_RdData_A : OUT std_logic_vector(31 downto 0) := (others => '0');
...
ARCHITECTURE impl OF BRAM_8kByte_A32_B32 IS
...
--------------------------------------------------------------------------------
	signal BRAM_WEN_A : std_logic_vector(3 downto 0);
...
ram4x : for i in 0 to 3 generate
	begin
		...
		o_BRAM_RdData_A(7+i*8 DOWNTO i*8) <= Din_A(i)(7 DOWNTO 0);
		o_BRAM_RdData_B(7+i*8 DOWNTO i*8) <= Din_B(i)(7 DOWNTO 0);

		Dout_A(i) <= x"0000_00" & i_BRAM_WrData_A(7+i*8 DOWNTO i*8);
		Dout_B(i) <= x"0000_00" & i_BRAM_WrData_B(7+i*8 DOWNTO i*8);

		WEN_A(i) <= BRAM_WEN_A(i) & BRAM_WEN_A(i) & BRAM_WEN_A(i) & BRAM_WEN_A(i);
