...
--	16.11.2017-le	add g_INIT_FILE, cop-master: never Rev >210 on GinMaster. this leads to a sw error
--------------------------------------------------------------------------------
--$Rev:: 4643                                                                  $
--$Author:: Leuthold                                                           $
--$Date:: 2017-11-16 17:55:16 +0100 (Do., 16 Nov 2017)                         $
--------------------------------------------------------------------------------
...
ENTITY BRAM_8kByte_A32_B32 is
	...
	generic (
		...
		g_INIT_FILE		: string := "..\C64_Master\COP_8k.mif";
	...
	port (
		...
		i_BRAM_Addr_A 	: IN  std_logic_vector(10 downto 0) := "00000000000";
