-- megafunction wizard: %Altera Unique Chip ID v14.0%
-- GENERATION: XML
-- chip_id.vhd

-- Generated using ACDS version 14.0 200 at 2014.07.01.09:24:36
...
architecture rtl of chip_id is
...
begin
	...
	chip_id_inst : component altchip_id
		generic map (
...
end architecture rtl; -- of chip_id
...
---->
-- Retrieval info: <instance entity-name="altchip_id" version="14.0" >
...
-- IPFS_FILES : chip_id.vho
-- RELATED_FILES: chip_id.vhd, altchip_id.v
