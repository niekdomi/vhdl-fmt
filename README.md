...
> [!INFO]
> Update: I am currently rewriting the project in Rust. While the new version
...
> can build from the [rewrite-in-rust](https://github.com/niekdomi/vhdl-fmt/tree/rewrite-in-rust) branch.
